...
class Contract(models.Model):
    ...
    PAYMENT_TYPE_CHOICES = (
        ...
        ("one_time", "One-Time Fixed Payment"),
    ...
    payment_type = models.CharField(
        max_length=20, choices=PAYMENT_TYPE_CHOICES, default="monthly"
    )
    total_contract_value = models.DecimalField(
        ...
        null=True,
        blank=True,
        help_text="Total value for one_time or milestone contracts",
    )
    billing_day = models.PositiveSmallIntegerField(
        default=1, help_text="Day of the month to bill (1-28)"
    )
